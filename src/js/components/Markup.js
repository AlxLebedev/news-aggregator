export default class Markup {
  ...
  getNotFoundMarkup() {
    ...
    <div class="not-found">
      <div class="not-found__wrapper">
        <svg class="not-found__image" width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="43" cy="43" r="36.5" stroke="#D1D2D6"/>
          <path d="M69 69L88.5 88.5" stroke="#D1D2D6"/>
          <path d="M58.3283 55.9592C54.6606 51.6981 49.2275 49 43.1642 49C37.1009 49 31.6678 51.6981 28 55.9592" stroke="#D1D2D6"/>
          <circle cx="55.5" cy="33.5" r="1.5" fill="#D1D2D6"/>
          <circle cx="30.5" cy="33.5" r="1.5" fill="#D1D2D6"/>
        </svg>
        <p class="not-found__warning">Ничего не найдено</p>
        <p class="not-found__message">К сожалению по вашему запросу ничего не найдено.</p>
      </div>
    </div>
    `;
  ...
  getServerErrorMarkup() {
    ...
    <div class="not-found">
      <div class="not-found__wrapper">
        <svg class="not-found__image" width="64" height="64" viewBox="0 0 64 64" enable-background="new 0 0 64 64" fill="#b6bcbf"><path d="M32,2C15.432,2,2,15.432,2,32s13.432,30,30,30c16.569,0,30-13.432,30-30S48.568,2,32,2z M32,59.5
        ...
        <p class="not-found__warning">Упс, проблемка...</p>
        <p class="not-found__message">Не получается получить ответ сервер.</p>
      </div>
    </div>
    `;

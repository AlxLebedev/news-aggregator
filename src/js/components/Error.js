/**
 * Class Error показывает или скрывает сообщение об ошибке, которая появляется в ответ на новостной запрос пользователя, если получен ответ от сервера, отличный от кода 200
 */
